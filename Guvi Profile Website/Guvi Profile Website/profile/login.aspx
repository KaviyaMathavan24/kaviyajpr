<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Guvi_Profile_Website.profile.login" %>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" runat="server">
                ...
                <div class="text-center">
                    <asp:LinkButton ID="lnksubmit"  class="btn btn-primary mt-4" runat="server" Text="Sign In"  CausesValidation="true" ValidationGroup="valsubmit" OnClick="lnksubmit_Click"></asp:LinkButton>
